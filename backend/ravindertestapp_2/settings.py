"""
Django settings for ravindertestapp_2 project.
...
ROOT_URLCONF = 'ravindertestapp_2.urls'
...
WSGI_APPLICATION = 'ravindertestapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravindertestapp_2 API",
    "DESCRIPTION": "API documentation for ravindertestapp_2 App",
    "VERSION": "v1",
}
